...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 21 Kas 2023, 18:58:20
...
--
-- Tablo için tablo yapısı `address_users`
--
...
CREATE TABLE `address_users` (
  ...
  `full_surname` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Tablo döküm verisi `address_users`
--

INSERT INTO `address_users` (`id`, `user_id`, `full_name`, `full_surname`, `company_name`, `country`, `city`, `zip_code`, `phone`, `email`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 1, 'full_name2', 'full_surname', 'company_name', 'country', 'city', 'zip_code', 'phone', 'email', NULL, '2023-11-20 18:33:17', NULL),
(2, 1, 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', '2023-11-20 18:34:06', '2023-11-20 18:34:06', NULL),
(3, 1, 'bir234', 'a', 'a', 'a', 'a', 'a', 'a', 'a', '2023-11-20 18:34:56', '2023-11-20 18:53:36', '2023-11-20 18:53:36'),
(4, 1, 'aaa', 'aaa', '11', '22', '22', '22', 'aa', '22', '2023-11-20 18:45:26', '2023-11-20 18:53:16', '2023-11-20 18:53:16');
...
CREATE TABLE `cart_shops` (
  ...
  `type_discount` bigint(20) UNSIGNED DEFAULT NULL COMMENT '1 pertancge, 2 cash',
...
(9, 'youtubeaboneol', 1, 17, 1, 222, NULL, '9,8,5,2', '2023-11-13 06:48:44', '2023-11-19 14:33:04', NULL);
...
(36, '655395dbce05d', 1, 80, 1, '2023-11-14 21:00:00', '2023-11-28 21:00:00', 1, '2023-11-14 12:44:27', '2023-11-15 11:01:56', NULL),
...
(8, 6, 'SPORT TWO', 'sport-two', '500', 500, 200, NULL, 'Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia, looked up one of the more obscure Latin words, consectetur, from a Lorem Ipsum passage, and going through the cites of the word in classical literature, discovered the undoubtable source. Lorem Ipsum comes from sections 1.10.32 and 1.10.33 of \"de Finibus Bonorum et Malorum\" (The Extremes of Good and Evil) by Cicero, written in 45 BC. This book is a treatise on the theory of ethics, very popular during the Renaissance. The first line of Lorem Ipsum, \"Lorem ipsum dolor sit amet..\", comes from a line in section 1.10.32.', 'Contrary Latin professorinia, loo passage, and going through the cites of the word in classical literature, discovered the undoubtable source. Lorem Ipsum comes from sections 1.10.32 and 1.10.33 of \"de Finibus Bonorum et Malorum\" (The Extremes of Good a', 1, 'products/6oDyKWARL4RbDVTRRtgD3pXzKPjGGONXI5kVsHzD.png', 1, 500, '2023-11-14 15:23:11', '2023-11-14 15:23:11', NULL),
...
INSERT INTO `sales` (`id`, `user_id`, `total`, `subtotal`, `created_at`, `updated_at`, `deleted_at`) VALUES
(12, 1, 49, 115, '2023-11-21 11:40:04', '2023-11-21 11:40:04', NULL),
(13, 1, 49, 115, '2023-11-21 11:41:40', '2023-11-21 11:41:40', NULL);

-- --------------------------------------------------------

--
-- Tablo için tablo yapısı `sale_addresses`
--
...
--
-- Tablo döküm verisi `sale_addresses`
--

INSERT INTO `sale_addresses` (`id`, `sale_id`, `full_name`, `full_surname`, `company_name`, `country`, `city`, `zip_code`, `phone`, `email`, `created_at`, `updated_at`, `deleted_at`) VALUES
(11, 12, 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', '2023-11-21 11:40:04', '2023-11-21 11:40:04', NULL),
(12, 13, 'full_name2', 'full_surname', 'company_name', 'country', 'city', 'zip_code', 'phone', 'email', '2023-11-21 11:41:40', '2023-11-21 11:41:40', NULL);

-- --------------------------------------------------------

--
-- Tablo için tablo yapısı `sale_details`
--
...
--
-- Tablo döküm verisi `sale_details`
--

INSERT INTO `sale_details` (`id`, `sale_id`, `product_id`, `type_discount`, `discount`, `quantity`, `product_size_id`, `product_color_size_id`, `code_cupon`, `code_discount`, `unit_price`, `subtotal`, `total`, `created_at`, `updated_at`, `deleted_at`) VALUES
(3, 12, 5, 1, 17, 2, NULL, NULL, 'youtubeaboneol', NULL, 50, 100, 34, '2023-11-21 11:40:04', '2023-11-21 11:40:04', NULL),
(4, 12, 1, NULL, 5, 3, NULL, NULL, NULL, NULL, 5, 15, 15, '2023-11-21 11:40:04', '2023-11-21 11:40:04', NULL),
(5, 13, 5, 1, 17, 2, NULL, NULL, 'youtubeaboneol', NULL, 50, 100, 34, '2023-11-21 11:41:40', '2023-11-21 11:41:40', NULL),
(6, 13, 1, NULL, 5, 3, NULL, NULL, NULL, NULL, 5, 15, 15, '2023-11-21 11:41:40', '2023-11-21 11:41:40', NULL);
...
--
-- Tablo için indeksler `address_users`
--
...
--
-- Tablo için indeksler `sale_addresses`
--
ALTER TABLE `sale_addresses`
  ADD PRIMARY KEY (`id`);

--
-- Tablo için indeksler `sale_details`
--
...
--
-- Tablo için AUTO_INCREMENT değeri `address_users`
--
ALTER TABLE `address_users`
...
--
-- Tablo için AUTO_INCREMENT değeri `sale_addresses`
--
ALTER TABLE `sale_addresses`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- Tablo için AUTO_INCREMENT değeri `sale_details`
--
ALTER TABLE `sale_details`
