...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 20 Kas 2023, 23:41:43
...
--
-- Tablo döküm verisi `cart_shops`
--

INSERT INTO `cart_shops` (`id`, `user_id`, `product_id`, `type_discount`, `discount`, `quantity`, `product_size_id`, `product_color_size_id`, `code_cupon`, `code_discount`, `unit_price`, `subtotal`, `total`, `created_at`, `updated_at`) VALUES
(34, 1, 5, 1, 17, 2, NULL, NULL, 'youtubeaboneol', NULL, 50, 100, 34, '2023-11-19 16:15:37', '2023-11-20 19:22:12'),
(35, 1, 1, NULL, 5, 3, NULL, NULL, NULL, NULL, 5, 15, 15, '2023-11-20 07:51:31', '2023-11-20 19:22:14');
...
--
-- Tablo için tablo yapısı `sale_address`
--
...
--
-- Tablo için indeksler `sale_address`
--
...
--
-- Tablo için AUTO_INCREMENT değeri `sale_address`
--
ALTER TABLE `sale_address`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
